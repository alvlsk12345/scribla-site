 ...
 * их совсем.
 *
 * favicon.ico, favicon.svg и favicon-192.png — 17 августа, по той же
 * причине. Лежат они в корне не от лени: Яндекс ищет файл с именем
 * favicon именно там, и объявленной из assets/brand ему мало.
 * У Google правила другие — корень ему не нужен, зато нужен квадрат
 * крупнее 48×48, и SVG в его списке форматов прямо не назван; отсюда
 * PNG на 192. Собираются они скриптом tools/build-favicon.py.
 *
...
const TAKE = ['index.html', 'privacy.html', 'support.html', 'robots.txt',
              'sitemap.xml', 'favicon.ico', 'favicon.svg', 'favicon-192.png',
