...
[$code, $answer] = $post($pack([
    ...
    // Своя версия у записи: она пролежала в очереди с прошлой сборки
    // и уехала уже из новой. Версия пачки её накрыть не должна.
...
$ok('своя версия записи важнее версии пачки: ' . ($rows[1]['app'] ?? '—'),
    ($rows[1]['app'] ?? '') === '0.8 (3)');
