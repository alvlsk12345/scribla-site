...
# Начала реплик. У ru и en сняты с дорожек со съёмки порогом -55 дБ.
# У es и zh съёмки не было вовсе: ролики сделаны позже и целиком
# сгенерированы, поэтому начала выбраны по картинке — реплика идёт
# чуть впереди пера, как в первых двух роликах. Перо там трогается
# позже (макро в начале длиннее), оттого и числа другие.
STARTS_ru="0.503 1.943 6.015"
STARTS_en="0.594 2.250 6.048"
STARTS_es="1.500 4.100 7.700"
STARTS_zh="1.000 3.000 7.400"
...
# в film-mix.sh поедет весь баланс. У es и zh сверять не с чем,
# поэтому взята величина английского — голос тот же самый.
TARGET_LUFS_ru=-17.8
TARGET_LUFS_en=-16.0
TARGET_LUFS_es=-16.0
TARGET_LUFS_zh=-16.0
