...
(() => {
  ...
  /* Приём переводов — страница CloudTips. Предзаполнение суммы через
     ?amount=N проверено живьём на 100 и 1000: поле подставляется.
     В документации этого нет — там описан только встраиваемый виджет,
     который мы не берём, чтобы не грузить чужой скрипт на страницу,
     где написано, что ничего никуда не уходит. */
